...
var topY=0,leftX=0;  //自定义定位偏移量 2007-02-11 由 [QQ763691523,hony]添加   
//选择日期 → 由 [QQ763691523,hony] 2007-06-10 添加，通过 ID 来选日期   
...
//选择日期 → 由 [QQ763691523,hony] 2006-06-25 添加   
function SelectDate(obj,strFormat,x,y)   
{   
  
    leftX =(x == null) ? leftX : x;   
    topY  =(y == null) ? topY : y;//自定义定位偏移量 2007-02-11 由 [QQ763691523,hony]添加    
 ...
 * @param p the pattern of your date  
 2006-06-25 由 [QQ763691523,hony] 修改为根据用户指定的 style 来确定；  
 */  
...
//2007-09-14  由[QQ763691523,hony]添加返回所选日期   
...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {   
  ...
  "sel_bg"        : "#FFCCFC",  //已被选择的日期单元格背影色 2006-12-03 [QQ763691523,hony]添加     
  "sun_word"      : "#934A03",  //星期天文字颜色     
  "sat_word"      : "#934A03",  //星期六文字颜色     
  "td_word_light" : "#333333",  //单元格文字颜色     
  "td_word_dark"  : "#888888",  //单元格文字暗色     
  "td_bg_out"     : "#786756",  //单元格背影色   
  "td_bg_over"    : "#110E0B",  //单元格背影色   
  "tr_word"       : "#FFFFFF",  //日历头文字颜色     
  "tr_bg"         : "#666666",  //日历头背影色   
  "input_border"  : "#CCCCCC",  //input控件的边框颜色     
  "input_bg"      : "#482F2F"   //input控件的背影色   
  }   
...
Calendar.prototype.draw = function() {   
  ...
  var mvAry = [];   
  //mvAry[mvAry.length]  = '  <form name="calendarForm" style="margin: 0px;">'; //因 <form> 不能嵌套， 2006-12-01 由[QQ763691523,hony]改用 Div   
  mvAry[mvAry.length]  = '  <div name="calendarForm" style="margin: 0px;background:#333;">';   
  mvAry[mvAry.length]  = '    <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px;background:#333;">';   
...
//2009-03-03 添加的代码，放置时间的行   
  ...
  /**//**//**//******** 以下代码由[QQ763691523,hony] 2006-12-01 添加 **********/  
  ...
  { calendar.ReturnDate(""); /*calendar.dateControl.value = "";calendar.hide();*///2007-09-14 由[QQ763691523,hony]注释   
  }   
...
Calendar.prototype.bindYear = function() {   
  var cy = this.calendarYear;//2006-12-01 由[QQ763691523,hony]修改   
  cy.length = 0;   
...
Calendar.prototype.bindMonth = function() {   
  var cm = this.calendarMonth;//2006-12-01 由[QQ763691523,hony]修改   
  cm.length = 0;   
  for (var i = 0; i < 12; i++){   
...
Calendar.prototype.update = function (e){   
  this.year  = e.calendarYear.options[e.calendarYear.selectedIndex].value;//2006-12-01 由[QQ763691523,hony]修改   
 ...
 var tds = this.getElementById("calendarTable").getElementsByTagName("td");   
  ...
  tds[i].style.backgroundColor = calendar.colors["td_bg_out"];   
    ...
    {   
      ...
      tds[i].style.cursor ="pointer"; //2007-08-06 由[QQ763691523,hony]添加，鼠标变成手指状   
...
Calendar.prototype.show = function (dateObj, popControl) {   
  ...
  var now =  new Date();   
  this.date = (dateObj.value.length > 0) ? new Date(dateObj.value.toDate(this.dateFormatStyle)) : now.format(this.dateFormatStyle).toDate(this.dateFormatStyle) ;//2008-01-29 [QQ763691523,hony]添加 → 若为空则根据dateFormatStyle初始化日期   
  ...
  this.panel.style.left = (xy.x + leftX)+ "px"; //由[QQ763691523,hony] 2007-02-11 修改 → 加入自定义偏移量   
  this.panel.style.top = (xy.y + topY + dateObj.offsetHeight) + "px";   
     
  //由[QQ763691523,hony] 2006-06-25 修改 → 把 visibility 变为 display，并添加失去焦点的事件  //this.setDisplayStyle("select", "hidden");   
...
//焦点转移时隐藏日历 → 由[QQ763691523,hony] 2006-06-25 添加   
Calendar.prototype.onblur = function() {   
    if(!isFocus){this.hide();}   
}   
  
//以下由[QQ763691523,hony] 2007-07-26 修改 → 确保日历容器节点在 body 最后，否则 FireFox 中不能出现在最上方   
...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
  ...
  "td_bg_out"     : "#444444",  //单元格背影色
  "td_bg_over"    : "#FFCC00",  //单元格背影色
  "tr_word"       : "#FFFFFF",  //日历头文字颜色  
  "tr_bg"         : "#666666",  //日历头背影色
  "input_border"  : "#CCCCCC",  //input控件的边框颜色  
  "input_bg"      : "#333333"   //input控件的背影色
  }
/* //2008-01-29 放到了 show ，因为要做 pickMode 判断
  this.draw();
  this.bindYear();
...
function InitContainerPanel() //初始化容器
{
 var str = '<div id="calendarPanel" style="position: absolute;display: none;z-index:9999; background-color: #444444;border: 1px solid #CCCCCC;width:175px;font-size:12px;display:none;"></div>';
 if(document.all)
 {
  str += '<div style="position:absolute;z-index:2000;width:expression(this.previousSibling.offsetWidth);';
  str += 'height:expression(this.previousSibling.offsetHeight);';
  str += 'left:expression(this.previousSibling.offsetLeft);top:expression(this.previousSibling.offsetTop);';
  str += 'display:expression(this.previousSibling.style.display);" scrolling="no" frameborder="no"></div>';
 }
 var div = document.createElement("div");
 div.innerHTML = str;
 div.id = "ContainerPanel";
...
//--> 
/*
SelectDate(this,'yyyy 年')
SelectDate(this,'yyyy 年 MM 月')
SelectDate(this,'yyyy-MM-dd')
SelectDate(this,'yyyy-MM-dd hh时')
SelectDate(this,'yyyy-MM-dd hh:mm')
SelectDate(this,'yyyy年MM月dd日 hh时mm分ss秒',0,-150)
