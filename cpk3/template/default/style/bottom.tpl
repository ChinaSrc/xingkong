...
<link href='<!--{$root_url}--><!--{$skinpath}-->style/footer.css' rel="stylesheet" type="text/css" />
            ...
            <div class="row">
                <div class="col-xs-3 footer_left padding_0">
                    ...
                    <div class="clearfix footer_l_content">
                        <a href="">
                            <div class="pull-left">
                                <img src="/static/images/dafayun.png" alt="">
                            </div>
                            <p class="pull-left" style="color: #555;">
                                <span>快三在线投注系统</span>
                                <span>专业彩票系统平台</span>
                            </p>
                        </a>
...
<div id="toolbar">
  ...
  <!-- download -->
    <div class="screen"><a href="#"></a>
        ...
        <script type="text/javascript" src="<!--{$root_url}--><!--{$skinpath}-->2018/sy2/js/clipboard.min.js"></script>
        <script>
...
<!--{if $userinfo['userid']>0 && $smarty.get.mod neq 'login' && $smarty.get.mod neq 'reg'}-->
