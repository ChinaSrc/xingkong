						...
						<div class="buy_rec">
							...
							<div class="un_box">
								...
								<div class="selt_bank "> 
									...
									<!--提交转账开始-->
									<form name="getMoneyForm" method="post" action="?mod=safe&code=tranfer&active=put">
										<ul>
												<li>
											<span class="paytdle">您的可用金额：</span><span class="">
									<!--{$amount['hig_amount']}-->元</span>
											...
											<li>
												...
												<input type="radio" name="type" value='1'  checked >充值
												 &nbsp;
												<input type="radio" name="type" value='2'  >活动
											</li>
