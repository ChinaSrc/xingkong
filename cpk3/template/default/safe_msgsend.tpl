...
.select_user1{    border-radius: 10px!important;
    box-shadow: 0 3px 10px #ccc;max-height:200px;overflow-y:scroll;line-height:30px;padding:10px 0px;    border-radius: 5px;width:300px;margin-bottom:10px;}

.select_user1  .active{background-color:#337ab7;}
ul li{display:block;width:100%; vertical-align: middle;padding-left:15px;}
ul li:hover{background-color:#1aa7A5;}
.select_user{width:300px;    border-radius: 5px;    position: relative;
...
<div style='background-color:#fff;'>
    <form name="form" action="home_safe_msgsend.html?from=parent" method="post">
<input type="hidden" name='type' id='type' value='1'>

<table style='width:100%;line-height:50px;margin-top:10px;'>

<tr>
<td align="right" style='width:100px;' >发给谁？</td>
<td>
...
<span class="input-group-addon"><img src='<!--{"static/images/search1.png"|getFileUri}-->'></span>
<input class="form-control multiselect-search" id='search' type="text" placeholder="查询"  oninput='search_user(this.value);'>
<span class="input-group-btn">
<button class="btn btn-default multiselect-clear-filter"  style='height:34px;' type="button"  onclick="close_search();"><img src='<!--{"static/images/close1.png"|getFileUri}-->'></button></span></div>
