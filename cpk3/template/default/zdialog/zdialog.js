...
Dialog.prototype.create = function () {
    ...
    var html = '\
	<div style="color:#222;border:0px solid #fff;background: #fff;">\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" onselectstart="return false;" >\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
          <td height="50px" >\
          <div style="padding-left:10px;line-height:50px; font-size:16px;float: left; color: #48576a;;">\
          <span id="_Title_' + this.ID + '" style="color:#222;font-size: 18px;font-weight: 600;">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);"  style="margin: 0px 0 0; position: relative; cursor: pointer; float: right; height: 50px; width: 28px;line-height:50px;' + (this.ShowCloseButton ? "" : "display:none;") + '"><img src="/static/images/icon_popup_close.png" title="关闭"></div></td>\
     </tr>\
    <tr valign="top">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style=" border-radius:0px 0px 8px 8px;text-align: center; background-color:#fff;">\
    ...
    if (this.Modal) {
		...
		if(bgdiv.style.display == "none"){
			if(this.Animator){
        		...
        		bgdiv.style.display = "";
				fadeEffect(bgMask,0,60,isIE6?20:10);
				bgMask=null;
			}else{
        		bgdiv.style.display = "";
			}
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:14px; color: #333;">' + msg + '</td></tr>\
	</table>';
    diag.show();
