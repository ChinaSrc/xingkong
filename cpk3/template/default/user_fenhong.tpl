...
<div class="pd20s">
                <div class="f-cb">
                    ...
                    状态：<span id="ContractState"><!--{if $fenhong['status']}--><!--{$status_arr[$fenhong['status']]}--><!--{else}-->未签订契约<!--{/if}--></span><span class="field-validation-valid ValidationMessage font-p Validform_checktip" data-valmsg-for="ErrorInput" data-valmsg-replace="true" id="SummaryValidate" style="margin-left:225px"></span>
                    <a id="dividendRuleLink" href="javascript: void(0)" class="btn3"  style='display:none;'>契约规则</a>
                </div>
                <div class="usercon">


<form action="home_user_fenhong.html?uid=<!--{$smarty.get.uid}-->" class="" id="CreateContractForm" method="post" novalidate="novalidate">      
