...
<script type="text/javascript" src="<!--{$file_uri}-->/static/js/common.js"></script>    
    ...
    <link rel="stylesheet" href="<!--{$file_uri}-->/<!--{$skinpath}-->style/fontello.css" />

    <link rel="stylesheet" href="<!--{$file_uri}-->/style/lottery.css" type="text/css" />
</head>
...
<script>
    if( document.body.clientWidth<500){
        if(location.href.indexOf('?')>0){
            var tourl=location.href+"&mobile=1"
        }
        else{
            var tourl=location.href+"?mobile=1"
        }
           ...
           <div class="info">
            ...
            <div id="navbar">
                ...
                <div id="settings">
                    ...
                    <a href="home_safe_chat.html"><i class="icon-squares"></i>转换						</a>
