...
<div style='background-color:#fff;'>
    <form name="form" action="home_user_quota.html?action=update&uid=<!--{$user['userid']}-->&mobile=1" method="post">
    ...
    <table class="my_tbl list_tbl">
        ...
        <tr  >
        <th style='line-height:25px;'>开户区段</th>
        <th style='line-height:25px;'>我的剩余配额</th>
        <th style='line-height:25px;'>下级剩余开户额</th>
        <th style='line-height:25px;'>增加(正数)、回收(负数)下级开户额</th>
