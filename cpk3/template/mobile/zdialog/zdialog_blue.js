 ...
 * zDialog 2.0
 * 涂红标
 * QQ：179119119 E-mail:179119119@qq.com
 * 最后修正：2009-12-18
 **/
//var rootURL=document.getElementById("rootURL").value;var pathName=G("pathName").value;var thisPathUrl=rootURL+"/"+pathName;
 
//var this_PATH=<?echo ROOT_URL;?>;"http://localhost:8081/yudu";//document.getElementById("RootPath").value;
var IMAGESPATH =ROOT_URL+ 'zdialog/images/blue/'; //图片路径配置
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="center" style="width:80px;"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'icon_alert.png" height="50"  align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:16px; font-weight: bold;color: #535e66;">' + msg + '</td></tr>\
	</table>';
    diag.show();
