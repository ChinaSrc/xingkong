...
var tpl_url=get_tpl_url();
//var this_PATH=<?echo ROOT_URL;?>;"http://localhost:8081/yudu";//document.getElementById("RootPath").value;
var IMAGESPATH =tpl_url+'/zdialog/images/black/'; //图片路径配置
...
Dialog.prototype.create = function () {
    ...
    var html = '\
	<div style="color:#222;border-radius:5px;padding-bottom: 5px;background-color: #fff; ">\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" style="border-radius:5px;" onselectstart="return false;" >\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
          <td height="35" style="padding:5px 5px;background-color:#e53333;border-bottom:1px #e53333 solid;border-radius: 5px 5px 0px 0px"><div style="padding-left:10px;line-height:30px;font-weight:800; font-size:16px;float: left; color:#fff;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);"  style="margin: 0px 0 0; position: relative; cursor: pointer; float: right; height: 30px; width: 28px;line-height:30px;' + (this.ShowCloseButton ? "" : "display:none;") + '"><img src="/data/uploads/xx.gif" style="vertical-align: middle"></div></td>\
     </tr>\
    <tr valign="top">\
        <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_' + this.ID + '" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#BF50C7;" id="_MessageTable_' + this.ID + '">\
                <tr>\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36" ><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5;  text-align: center; ">\
                 <a value="确 定" class="buy_btn" id="_ButtonOK_' + this.ID + '"/>确定</a>\
                <a class="cance_btn"  onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>取消</a>\
              </div></td>\
          </tr>\
        </table></td>\
     </tr>\
    ...
    if (this.Modal) {
		...
		if(bgdiv.style.display == "none"){
			if(this.Animator){
        		...
        		bgdiv.style.display = "";
				fadeEffect(bgMask,0,70,isIE6?20:10);
				bgMask=null;
			}else{
        		bgdiv.style.display = "";
			}
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
		...
		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:#000;opacity:0.7;filter:alpha(opacity=70);width:100%;height:100%;"></div>';
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="center" id="Message_' + this.ID + '" style="font-size:14px; color: #333;">' + msg + '</td></tr>\
	</table>';
    diag.show();
