                ...
                <div class="activity" >
                    ...
                    <div class="floor fix" <!--{if $con_system['active_day_open'] neq '1'}--> style='display:none;' <!--{/if}-->>
                        <div class="actTitle fix" onclick="show_detail(0);">
                            <img src="<!--{$con_system['active_day_pic']}-->" alt="" class="ImgLI floorTitleImg defaultImg" />
                    ...
                    <div class="floor fix">
                        <div class="actTitle fix" onclick="show_detail(1);">
                            <img src="<!--{$con_system['active_vip_pic']}-->" alt="" class="ImgLI floorTitleImg defaultImg" />
                            <div class="floorRright">
                                <h2>晋级奖励</h2>
                ...
                <!--{foreach from=$list key=key item=item}-->
                    ...
                    <div class="floor fix">
                        <div class="actTitle fix" onclick="show_detail(<!--{$key+2}-->);">
                            <img src="<!--{$item['banner']}-->" alt="" class="ImgLI floorTitleImg defaultImg" />
                            <div class="floorRright">
                                <h2><!--{$item['title']}--></h2>
                                <p><!--{$item['desc']}--></p>
                                <a >查看详情<i></i></a>
