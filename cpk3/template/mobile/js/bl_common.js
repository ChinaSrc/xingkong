...
f_com.Quota = function(P_Type){
    try{
        ...
        $.ajax({
            type:'POST',
            url :'index.aspx?module=MGetData&method=GetMemLimitInfo',
            data:f_com.postArray(ager),
            cache:false,
            async:false,
            dataType:'json',
...
$(document).ready(function(){
    ...
    */
    ...
    $("#LiveServerGroup").change(function(){
        $.ajax({
            type:'GET',
            url:'/app/member/browse/cookie_other.aspx?SocketName=SocketValue&SocketValue='+$('#LiveServerGroup option:selected').val(),
            data:{},
            error:function(msg){
            },
            success:function(data){
