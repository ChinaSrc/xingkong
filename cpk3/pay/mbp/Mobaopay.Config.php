 ...
 */
	...
	// Mo宝支付系统密钥
	$mbp_key =  $con_system['pay_mbp_key'];
	// Mo宝支付系统网关地址（正式环境）
	...
	// 商户在Mo宝支付的平台号
	$platform_id =  $con_system['pay_mbp_id'];
	// Mo宝支付分配给商户的账号
	$merchant_acc =  $con_system['pay_mbp_acc'];
	// 商户通知地址（请根据自己的部署情况设置下面的路径）
	$merchant_notify_url = .$_GET['backurl']."/index.aspx/cash/pay_mbp_back";
