...
<head>
    ...
    <title>GLPay PHP Demo Index</title>
</head>
<body>

<form  id='formpay' name='formpay' method='post' action='https://www.glpay.com/pay'>
    <input name='goodsname' id='goodsname' type='text' value='在线充值' />
    <input name='istype' id='istype' type='text' value='1' />
    ...
    <input name='orderuid' id='orderuid' type='text' value='<?php echo $orderid;?>'/>
    ...
    <p><input id="inputprice" type="text" name="price" class="form-control" placeholder="请输入金额" required></p>
