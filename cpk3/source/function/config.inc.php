...
if($_SESSION['isproxy']==1){
	...
	$NaviList=array(
    'safe'=>array('info'=>"修改资料",'pass'=>"登录密码",'pwd2'=>"提现密码",'bankinfo'=>"银行卡绑定",'msg'=>'站内消息'),
    'records'=>array('list'=>"投注记录",'task'=>"追号记录",'hemai'=>'合买记录','fandian'=>"返点记录",'fenhong'=>"分红记录"),
...
$arr_game_code=array('k3'=>'快三','ssc'=>'时时彩','11x5'=>'11选5','kl8'=>'快乐8','pk10'=>'PK10','dp'=>'3D/P3');
			 $bank_arr=array("微信支付","支付宝","财付通","中国工商银行","中国农业银行","中国建设银行","中国银行","中国邮政储蓄银行","交通银行","中国民生银行","中国光大银行","兴业银行","招商银行",
				 "广发银行","平安银行","华夏银行","上海银行");
...
$arr_menu[100]=array('个人信息','image/icons/item43.gif');
		...
		$arr_item[0][] =array("访问权限","controller=system&action=config&type=permissions",'1');
...
$recharge_type_arr1=array('hand'=>'银行转账','online'=>'第三方支付','chat'=>'聊天室');
?>
