 ...
 * File:        Smarty.class.aspx
 * SVN:         $Id: Smarty.class.aspx 3794 2010-11-15 22:54:59Z uwe.tews@googlemail.com $
 * 
...
class Smarty extends Smarty_Internal_Data {
    ...
    */
     ...
     * plugin filename format: plugintype.pluginname.aspx
     * 
    ...
    { 
        ...
        // plugin filename is expected to be: [type].[name].aspx
        $_plugin_filename = "{$_name_parts[1]}.{$_name_parts[2]}.aspx"; 
