...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=';echo SZS_CHARSET;echo '" />
<title>系统提示</title>
<style>
...
.alert .alert_body .alertcont{margin:15px 0 0 85px; background:url(';echo SZS_ROOT_URL;echo 'tpl/static/images/m_alert.png) left center no-repeat; padding:5px 50px; line-height:18px; color:#666; min-height:30px; _height:30px;}
...
.alert .alert_body .pi2{background:url(';echo SZS_ROOT_URL;echo 'tpl/static/images/m_err.png) left center no-repeat;}
.alert .alert_body .pi1{background:url(';echo SZS_ROOT_URL;echo 'tpl/static/images/m_acc.png) left center no-repeat; padding-left:55px;}
...
_top:       expression(eval(document.compatMode &&
			...
			.message .alert_body{ padding:0; height:163px; width:495px; border:1px solid #FFFFFF;}
...
break;
case 1;
echo("<p class=\"btn\"><a href=\"javascript:history.go(-1);\"><img src=\"".SZS_ROOT_URL."tpl/static/images/return.gif\" /> </a></p>");
break;
case 2;
echo("<p class=\"btn\"><a href=\"javascript:history.go(-1);\"><img src=\"".SZS_ROOT_URL."tpl/static/images/return.gif\" /> </a></p>");
break;
