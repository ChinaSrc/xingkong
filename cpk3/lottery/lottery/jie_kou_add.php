...
$disc="";
if($id!=""){
$sqls="select * from jiekou_add where id='$id'";
...
;echo ' 
     ...
     <form method="POST" action="';echo ROOT_URL."/".$AdminPath;;echo '/?action=save_post&flag=yes&active=jie_kou&id=';echo $id;;echo '" name="form1" id="form1">
...
;echo '                          </select>&nbsp;期
					  ...
					  <td >方案ID</td>
					    ...
					    <input type="text" name="fn_id"  id="fn_id" value="" />
					    </td>
			     </tr>
				 <tr height=30 bgcolor="#FFFFFF"> 
				     <td>开奖号码：</td>
				     <td align=left valign=middle colspan=3>&nbsp;
				     <textarea id=\'lott_num\' name=\'lott_num\' style=\'width:90%;border:#ccc 1px solid;\' rows=6 >';echo $rowss[nr];;echo '</textarea> 
					 &nbsp;
					 </td>
